...
inline void application_msg_t::clear_timetable_str() {
  timetable_str_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000001u;
}
...
inline const std::string& application_msg_t::_internal_timetable_str() const {
  return timetable_str_.GetNoArena();
}
inline void application_msg_t::_internal_set_timetable_str(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  timetable_str_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void application_msg_t::set_timetable_str(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  timetable_str_.SetNoArena(
...
inline void application_msg_t::set_timetable_str(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  timetable_str_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:application_msg_t.timetable_str)
}
inline void application_msg_t::set_timetable_str(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  timetable_str_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* application_msg_t::_internal_mutable_timetable_str() {
  _has_bits_[0] |= 0x00000001u;
  return timetable_str_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* application_msg_t::release_timetable_str() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return timetable_str_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void application_msg_t::set_allocated_timetable_str(std::string* timetable_str) {
  ...
  timetable_str_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), timetable_str);
