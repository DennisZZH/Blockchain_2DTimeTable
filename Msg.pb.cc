...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_application_msg_t_Msg_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_application_msg_t_Msg_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Msg_2eproto = {
  false, false, descriptor_table_protodef_Msg_2eproto, "Msg.proto", 32,
